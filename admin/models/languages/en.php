...
$lang = array_merge($lang,array(
	...
	"ACCOUNT_SPECIFY_DEPARTMENT"	=> "Please enter your department",
	"ACCOUNT_SPECIFY_MINISTRY"		=> "Please enter your ministry",
	...
	"ACCOUNT_INACTIVE"				=> "Your account is in-active. Contact Admin for assistance.",
	...
	"ACCOUNT_NEW_ACTIVATION_SENT"	=> "We have emailed you a new activation link, please check your email. (Remember to check your Junk/Spam Email Folder)",
	...
	"ACCOUNT_REGISTRATION_COMPLETE_TYPE1"	=> "You have successfully registered. An email has been sent to the Administrator for account activation. You will receive communication once this is done.",
	"ACCOUNT_REGISTRATION_COMPLETE_TYPE2"	=> "You have successfully registered. An email has been sent to the Administrator for account activation. You will receive communication once this is done.",
...
$lang = array_merge($lang,array(
	...
	"FORGOTPASS_NEW_PASS_EMAIL"		=> "We have emailed you a new password. Remember to check your Junk/Spam Email Folder.",
	...
	"FORGOTPASS_REQUEST_SUCCESS"		=> "We have emailed you instructions on how to regain access to your account. Remember to check your Junk/Spam Email Folder.",
	));
