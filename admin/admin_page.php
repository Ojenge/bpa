...
if ($pageDetails['private'] == 1){
	echo "<input type='checkbox' name='private' id='private' value='Yes' checked='checked'>";
}
else {
...
<p>
<label>&nbsp;</label>
<input type='submit' onClick='updatePageInfo()' value='Update' class='submit' />
</p>
</div>";
?>