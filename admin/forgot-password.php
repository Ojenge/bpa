...
if(!empty($_POST))
{
	...
	if($home == 'Home'){ header("Location: index.php"); die(); }
...
echo "
<div id='regbox'>
<table align='center' style='background-color:#E0E0E0; border-radius:15px; -moz-border-radius:15px; -webkit-border-radius:15px;'>
<tr>
	<td colspan='2' align='center'><img src='../images/BPALogo.png'/></td>
</tr>
<tr><td colspan='2' align='center'><h3>Forgot Password</h3></td></tr>
...
<tr><td>&nbsp;</td><td>
<input type='submit' value='Submit' class='submit' /><input type='submit' name='home' value='Home'/>
</td></tr>
</form>
</table>
</div>
