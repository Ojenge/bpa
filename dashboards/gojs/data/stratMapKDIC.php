...
$stratMap .= '{"key":"obj115", "text":"Establish & Enhance Strategic\nCollaborations and Partnerships\nwith Relevant Stakeholders", "group":"customer", "fill":"'.getMapColor("obj35").'", "location":"82 122"},
{"key":"obj114", "text":"Improve Public Awareness Index\nfrom 14% to 28% by 2028", "group":"customer", "fill":"'.getMapColor("obj35").'", "location":"340 129"},
{"key":"obj117", "text":"Wind up Financial Institutions\nin Liquidation", "group":"customer", "fill":"'.getMapColor("obj35").'", "location":"605 129"},';

$stratMap .= '{"key":"obj118", "text":"Automate Processes & Digitise Records", "group":"processes", "fill":"'.getMapColor("obj38").'", "location":"64 250"},
