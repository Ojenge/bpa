...
$initiative_deliverable = mysqli_real_escape_string($connect, $initiative_deliverable) ?? '';
...
$initiative_Scope = mysqli_real_escape_string($connect, $initiative_Scope) ?? '';
...
$initiative_Status_Details = mysqli_real_escape_string($connect, $initiative_Status_Details) ?? '';
if(!empty($_POST['initiativeNotes']))$initiativeNotes = $_POST["initiativeNotes"];
$initiativeNotes = mysqli_real_escape_string($connect, $initiativeNotes);
