...
--
-- Host: localhost
-- Generation Time: Jul 08, 2025 at 01:13 PM
...
(1, 'Develop, implement & monitor implementation of the departmental work plan', '', 'ind8', NULL, NULL, '2025-07-01', '2026-06-30', NULL, NULL, NULL, 'Actioned Departmental Work Plan', 'off', '', 'Initiative', '', '', NULL, 'No', '2025-07-02 07:07:21'),
(2, 'Develop & monitor implementation of the departmental budget', '', 'ind8', NULL, NULL, '2025-07-01', '2026-06-30', NULL, NULL, NULL, 'Fully absorbed budget', 'off', '', 'Initiative', '', '', NULL, 'No', '2025-07-02 07:07:53'),
...
('kpi1', 'Growth of the Investment income', 'Yearly', 'Standard KPI', '', 'obj111', 'Currency', 'Last Value', 'ind0', 'ind0', NULL, '26960000000', '0', '31200000000', '', NULL, 'threeColor', '', 'No', 3000, '[]'),
...
('obj111', 'Deposit Insurance', 'Prudent Management of the Deposit Insurance Fund', '', 'persp8', NULL, '[]', NULL, NULL, NULL, '', '0.33', 3000, NULL),
...
--
-- Table structure for table `objectivedestination`
--

CREATE TABLE `objectivedestination` (
  `id` int NOT NULL,
  `objectiveId` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `from` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL,
  `to` varchar(45) CHARACTER SET latin1 COLLATE latin1_swedish_ci DEFAULT NULL
) ENGINE=InnoDB DEFAULT CHARSET=latin1;
...
INSERT INTO `perspective` (`id`, `name`, `parentId`, `weight`) VALUES
('persp10', 'Internal Business Process Perspective', 'org1', '16'),
('persp11', 'Organisational Capacity', 'org1', '18'),
('persp12', 'Financial Perspective', 'org2', '0.25'),
('persp13', 'Customer Perspective', 'org2', '0.25'),
('persp14', 'Internal Business Process', 'org2', '0.25'),
('persp15', 'Learning & Growth', 'org2', '0.25'),
('persp16', 'Financial Perspective', 'org4', '0.25'),
('persp17', 'Customer Perspective ', 'org4', '0.25'),
('persp18', 'Internal Business Process', 'org4', '0.25'),
('persp19', 'Organisational Capacity', 'org4', '0.25'),
('persp20', 'Financial Perspective', 'org5', '0.25'),
('persp21', 'Customer Perspective', 'org5', '0.25'),
('persp22', 'Learning & Growth Perspective', 'org5', '0.25'),
('persp23', 'Internal Business Process Perspective', 'org6', '0.25'),
('persp24', 'Learning & Growth', 'org6', '0.25'),
('persp25', 'Financial Perspective', 'org6', '0.25'),
('persp26', 'Customer Perspective', 'org6', '0.25'),
('persp27', 'Financial Perspective', 'org7', '0.33'),
('persp28', 'Customer Perspective', 'org7', '0.33'),
('persp29', 'Internal Business Process Perspective', 'org7', '0.33'),
('persp3', 'Internal Processes', 'org1', '0.13'),
('persp30', 'Internal Business Process Perspective', 'org5', '0.25'),
('persp31', 'Financial Perspective', 'org8', '0.33'),
('persp32', 'Customer Perspective', 'org8', '0.33'),
('persp33', 'Internal Business Process Perspective', 'org8', '0.33'),
('persp4', 'Organisational Capacity', 'org1', '0.13'),
('persp8', 'Financial Perspective', 'org1', '0.13'),
('persp9', 'Customer Perspective', 'org1', '0.13');
...
INSERT INTO `tree` (`idTree`, `id`, `name`, `parent`, `type`, `linked`, `sort`) VALUES
(1, 'root', 'Root', '', '', NULL, 1000),
(2, 'org1', 'KDIC', 'root', 'organization', 'no', 1000),
...
(1, 'ind1', 'admin', 'Administrator', NULL, NULL, 'images/profilePics/adminProfile.png', 'd2979b7003f56f457a0d0412ecee7639f08accdbf704c85e051fb1683bff56a0c', 'lkyonze@gmail.com', 'ded5bc0361090fbf5fe50b5276f70f22', 1584885154, 0, 1, 'Accent Admin', 'org0', 1584885154, 1751972793),
...
(3, 'ind3', 'hellen.chepkwony', 'Hellen Chepkwony', 'ind1', NULL, NULL, 'de8556fdeba19f9a7e545013c0ed343e6e4ff66708769b86bbc3e6aa487889310', 'hellen.chepkwony@kdic.go.ke', '179639ba2d206dbb7a7f146c706693e2', 1750945122, 0, 1, 'CEO', 'org1', 1750945122, 1751025033),
...
(5, 'ind5', 'paul.manga', 'Paul Manga', 'ind3', NULL, NULL, '210834fd6f1ef9b291a042d07af0edbeb3c0f55a93b119fdb20644b33d438fd69', 'paul.manga@kdic.go.ke', '02ef5815238a8f55de48895e57492d2c', 1750947032, 0, 0, 'Director, DI & BS', 'org7', 1750947032, 0),
(6, 'ind6', 'mary.kiragu', 'Mary Kiragu', 'ind3', NULL, NULL, '7bd5023971c7be225b06c28a08887f12f3343bd6629618ed164ccfe55e3ffc2bb', 'mary.kiragu@kdic.go.ke', 'e2cf2c2ceb65685592681910395da70b', 1750947360, 0, 0, 'DIrector, Internal Audit', 'org5', 1750947360, 0),
(7, 'ind7', 'lawrence.shoona', 'Lawrence Shoona', 'ind3', NULL, NULL, '09f4aee4435860484065276ea5635f2fc54840da2197002e57c6e2166e39f2c35', 'shoonal@kdic.go.ke', 'a152f9508538933e9540221c13a81ae9', 1750947447, 0, 0, 'Deputy Director, Strategy & Planning', 'org5', 1750947447, 0),
(8, 'ind8', 'eunice.kitche', 'Eunice Kitche', 'ind3', NULL, NULL, '73cb3e121cc0e052ccae6597e271170f82355f9d2d7434a6839272a269119a319', 'eunice.kitche@kdic.go.ke', 'e930154a3d9fea3d48d2f867ce258fc1', 1750947811, 0, 0, 'Director, Legal', 'org2', 1750947811, 0),
...
--
-- Indexes for table `objectivedestination`
--
ALTER TABLE `objectivedestination`
  ADD PRIMARY KEY (`id`);
